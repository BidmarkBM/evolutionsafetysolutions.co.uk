...
function ruffer_pagination( $args = array() ) {
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'ruffer' ),
        'next_string'     => esc_html__( '&raquo;', 'ruffer' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'ruffer_pagination_defaults', $defaults )
    );
