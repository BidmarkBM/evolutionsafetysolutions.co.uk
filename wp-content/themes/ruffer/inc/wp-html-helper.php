...
// image default alt
if( !function_exists( 'ruffer_img_default_alt' ) ){
	function ruffer_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'ruffer_img_tag' ) ){
	function ruffer_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = ruffer_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'ruffer_anchor_tag' ) ){
	function ruffer_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'ruffer_heading_tag' ) ){
	function ruffer_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'ruffer_paragraph_tag' ) ){
	function ruffer_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'ruffer_span_tag' ) ){
	function ruffer_span_tag( array $args ){
