 ...
 * @Packge      Ruffer
 * @Author      Themeholy
 * @Author URL  https//www.th.com
 * @version     1.0
 *
 */

if ( ! function_exists( 'ruffer_breadcrumbs' ) ) {
    function ruffer_breadcrumbs( $args = array() ) {
        if ( is_front_page() ) {
            return;
        }
        ...
        $defaults  = array(
            ...
            'home_title'          => esc_html__( 'Home', 'ruffer' )
        );
        $args    = apply_filters( 'ruffer_breadcrumbs_args', wp_parse_args( $args, $defaults ) );
        ...
        */
        ...
        if ( is_singular( 'post' ) ) {
            ...
            $html .= '<li class="active bread-search">'.esc_html__('Search results for: ','ruffer') . get_search_query() . '</li>';
        } elseif ( is_404() ) {
            $html .= '<li>' . esc_html__( 'Error 404', 'ruffer' ) . '</li>';
        } elseif ( is_home() ) {
        ...
        if( class_exists('woocommerce') ) {
            ...
            echo apply_filters( 'ruffer_breadcrumbs_filter', $html );
        }
