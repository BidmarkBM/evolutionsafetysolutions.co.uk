...
add_action('elementor/widgets/register', 'ess_register_evo_filterable_products_widget');
function ess_register_evo_filterable_products_widget($widgets_manager)
{
    if (! did_action('elementor/loaded')) {
        return;
    }

    require_once get_stylesheet_directory() . '/widgets/evo-filterable-products__elementor-widget.php';

    if (class_exists('\Elementor\Evo_Filterable_Products_Elementor_Widget')) {
        $widgets_manager->register(new \Elementor\Evo_Filterable_Products_Elementor_Widget());
    }
}
