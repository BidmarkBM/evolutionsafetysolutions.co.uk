...
class ruffer_recent_posts_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                'ruffer_recent_posts_widget',

                // Widget name will appear in UI

                esc_html__( 'Ruffer :: Recent Posts', 'ruffer' ),
                ...
                array(
                    ...
                    'description'                   => esc_html__( 'Add Recent Posts Widget', 'ruffer' ),
                )
            );
        }
                                    ...
                                    echo '<div class="media-img">';
                                        echo '<a href="'.get_the_permalink().'">';
                                            echo ruffer_img_tag( array(
                                                "url"   => esc_url( get_the_post_thumbnail_url( null, 'ruffer_85X85' ) ),
                                            ) );
                                        echo '</a>';
                                    echo '</div>';
                                }
        ...
        public function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:' ,'ruffer'); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'post_count' ); ?>"><?php _e( 'Number of Posts to show:' ,'ruffer'); ?></label>
    ...
    } // Class ruffer_recent_posts_widget ends here


    // Register and load the widget
    function ruffer_recent_posts_load_widget() {
        register_widget( 'ruffer_recent_posts_widget' );
    }
    add_action( 'widgets_init', 'ruffer_recent_posts_load_widget' );