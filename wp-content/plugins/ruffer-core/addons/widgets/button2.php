 ...
 *
 */
class Ruffer_Button2 extends Widget_Base {

	public function get_name() {
		return 'rufferbutton2';
	}
	public function get_title() {
		return __( 'Button V2', 'ruffer' );
	}
	...
	protected function register_controls() {
		...
		ruffer_general_fields($this, 'button_text', 'Button Text', 'TEXT', 'Button Text');
		ruffer_general_fields($this, 'button_extra_class', 'Button Extra Class', 'TEXT', '');
		ruffer_url_fields($this, 'button_url', 'Button URL');
		ruffer_general_fields($this, 'button_icon', 'Button Icon Class', 'TEXT', '');
		...
		$this->add_control(
			'button_space',
			[
				'label' => esc_html__( 'Button Icon Spacing (PX)', 'ruffer' ),
		...
		//------Button Style-------
		ruffer_button_style_fields($this, '10', 'Button Styling', '{{WRAPPER}} .th_btn', ['1']);
