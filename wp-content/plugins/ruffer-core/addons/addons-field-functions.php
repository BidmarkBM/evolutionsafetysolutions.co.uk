...
// General Fields
// ruffer_general_fields($th, $id, $label, $field_type, $default_value, $condition = null);
if (!function_exists('ruffer_general_fields')) {
    function ruffer_general_fields($th, $id, $label, $field_type, $default_value, $condition = null) {

        $control_args = [
            'label'      => __( $label, 'ruffer' ),
            'default'       => __( $default_value , 'ruffer' ),
        ];
...
// Media Fields
// ruffer_media_fields($th, $id, $label, $condition = null);
if (!function_exists('ruffer_media_fields')) {
    function ruffer_media_fields($th, $id, $label, $condition = null) {
...
// URL Fields
// ruffer_url_fields($th, $id, $label, $condition = null);
if (!function_exists('ruffer_url_fields')) {
    function ruffer_url_fields($th, $id, $label, $condition = null) {
...
// SELECT Fields
// ruffer_select_field($th, $id, $label, $options = [], $condition = null);
if (!function_exists('ruffer_select_field')) {
    function ruffer_select_field($th, $id, $label, $options = [], $condition = null) {
...
// Switcher Fields
// ruffer_switcher_fields($th, $id, $label, $condition = null);
if (!function_exists('ruffer_switcher_fields')) {
    function ruffer_switcher_fields($th, $id, $label, $condition = null) {
...
// Code Fields
// ruffer_code_fields($th, $id, $label, $condition = null);
if (!function_exists('ruffer_code_fields')) {
    function ruffer_code_fields($th, $id, $label, $default_value, $condition = null) {
...
// Social Repeater
// ruffer_social_fields($this, 'social', 'Social List');
if (!function_exists('ruffer_social_fields')) {
    function ruffer_social_fields($th, $id, $label, $condition = null) {
...
// Common Repeater
// ruffer_common_repeater_field($th, $label, $fields, $condition = null)
if (!function_exists('ruffer_common_repeater_field')) {
    function ruffer_common_repeater_field($th, $id, $label, $fields, $condition = null) {
            ...
            switch ($field) {
                case 'subtitle':
                    $repeater->add_control(
                        ...
                        [
                            'label'         => esc_html__($label . ' Subtitle', 'ruffer'),
                            'type'          => \Elementor\Controls_Manager::TEXTAREA,
                            'default'       => __('Subtitle here', 'ruffer'),
                            'label_block'   => true,
                            'rows'          => 2,
                        ]
                    );
                ...
                case 'title':
                    $repeater->add_control(
                        $control_id . '_title',
                        [
                            'label'         => esc_html__($label . ' Title', 'ruffer'),
                            'type'          => \Elementor\Controls_Manager::TEXTAREA,
                            'default'       => __('Title here', 'ruffer'),
                            'label_block'   => true,
                            'rows'          => 2,
                        ]
                    );
                ...
                case 'text':
                    $repeater->add_control(
                        $control_id . '_text',
                        [
                            'label'         => esc_html__($label . ' Text', 'ruffer'),
                            'type'          => \Elementor\Controls_Manager::TEXTAREA,
                            'default'       => __('Text here', 'ruffer'),
                            'label_block'   => true,
                            'rows'          => 4,
                        ]
                    );
                ...
                case 'icon2':
                    $repeater->add_control(
                        $control_id . '_icon2',
                        [
                            'label'         => esc_html__($label . ' Icon', 'ruffer'),
                            'type'          => \Elementor\Controls_Manager::TEXTAREA,
                            'default'       => __('<i class="fa-light fa-clock"></i>', 'ruffer'),
                            'label_block'   => true,
                            'rows'          => 2,
                        ]
                    );
                ...
                case 'image':
                    $repeater->add_control(
                        $control_id . '_image',
                        [
                            'label'     => esc_html__($label . ' Image', 'ruffer'),
                            'type'      => \Elementor\Controls_Manager::MEDIA,
                            'dynamic'   => [
                                'active' => true,
                            ],
                ...
                case 'button':
                    $repeater->add_control(
                        $control_id . '_button',
                        [
                            'label'         => esc_html__($label . ' Button', 'ruffer'),
                            'type'          => \Elementor\Controls_Manager::TEXTAREA,
                ...
                case 'link':
                    $repeater->add_control(
                        $control_id . '_link',
                        [
                            'label'         => esc_html__($label . ' Link', 'ruffer'),
                            'type' 			=> Controls_Manager::URL,
                            'placeholder' 	=> __( 'https://your-link.com', 'ruffer' ),
                            'show_external' => true,
                            'default' 		=> [
        ...
        $th->add_control(
            $id,
            [
                'label'         => esc_html__($label . ' Lists', 'ruffer'),
                'type'          => \Elementor\Controls_Manager::REPEATER,
                'fields'        => $repeater->get_controls(),
                'default'       => [
                    [
                        $control_id . '_title' => __('Title', 'ruffer'),
                    ],
                ],
                'condition' => [
                    'layout_style' => $condition
...
// Repeater
// ruffer_repeater_fields($this, 'repeater', 'Repeater List');
if (!function_exists('ruffer_repeater_fields')) {
    function ruffer_repeater_fields($th, $id, $label, $fields = array(), $condition = null) {
        $repeater = new Repeater();
...
// Slider option
// function ruffer_elementor_slider_options($th, $condition = null)
if (!function_exists('ruffer_elementor_slider_options')) {
    function ruffer_elementor_slider_options($th, $condition = null) {
        ...
        $th->add_control(
			'slider_id',
			[
				'label' 		=> __( 'Slider ID', 'ruffer' ),
				'type' 			=> \Elementor\Controls_Manager::TEXT,
                'condition'		=> [ 'make_it_slider' => [ 'yes' ] ],
                'default' 		=> __( 'thSlider1', 'ruffer' ),
			]
		);
		...
		$th->add_control(
			'desktop_items',
			[
				'label' 		=> __( 'Items To Show (1300 +)', 'ruffer' ),
		...
		$th->add_control(
			'large_laptop_items',
			[
				'label' 		=> __( 'Large Laptop Items (max 1300)', 'ruffer' ),
				'type' 			=> \Elementor\Controls_Manager::SLIDER,
				'size_units' 	=> [ '%' ],
				'range' 		=> [
					'%' 	=> [
		...
		$th->add_control(
			'laptop_items',
			[
				'label' 		=> __( 'Laptop Items (max 1200)', 'ruffer' ),
				'type' 			=> \Elementor\Controls_Manager::SLIDER,
				'size_units' 	=> [ '%' ],
				'range' 		=> [
					'%' 	=> [
        ...
        $th->add_control(
			'tablet_items',
			[
				'label' 		=> __( 'Tablet Items (max 922)', 'ruffer' ),
				'type' 			=> \Elementor\Controls_Manager::SLIDER,
				'size_units' 	=> [ '%' ],
				'range' 		=> [
					'%' 	=> [
        ...
        $th->add_control(
			'mobile_items',
			[
				'label' 		=> __( 'Mobile Items (max 768)', 'ruffer' ),
				'type' 			=> \Elementor\Controls_Manager::SLIDER,
				'size_units' 	=> [ '%' ],
				'range' 		=> [
					'%' 	=> [
        ...
        $th->add_control(
			'small_mobile_items',
			[
				'label' 		=> __( 'Small Mobile (max 576)', 'ruffer' ),
				'type' 			=> \Elementor\Controls_Manager::SLIDER,
				'size_units' 	=> [ '%' ],
				'range' 		=> [
					'%' 	=> [
