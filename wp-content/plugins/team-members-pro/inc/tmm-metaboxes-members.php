...
function dmb_tmmp_social_links_options()
{
    $options = [
        __('-', TMMP_TXTDM) => 'nada',
        __('X (Twitter)', TMMP_TXTDM) => 'twitter',
        __('LinkedIn', TMMP_TXTDM) => 'linkedin',
        __('YouTube', TMMP_TXTDM) => 'youtube',
        __('WhatsApp', TMMP_TXTDM) => 'whatsapp',
        __('Messenger', TMMP_TXTDM) => 'messenger',
        __('WeChat', TMMP_TXTDM) => 'wechat',
        ...
        __('Google+ (deprecated)', TMMP_TXTDM) => 'googleplus',
    ];
    ...
    <div class="dmb_inner">
        ...
        <div class="dmb_grid dmb_grid_25 dmb_grid_first">
            ...
            <input class="dmb_field dmb_highlight_field dmb_firstname_of_member" type="text"
                value="<?php echo $member['_tmm_firstname']; ?>"
        ...
        <div class="dmb_grid dmb_grid_25 ">
            ...
            <input class="dmb_field dmb_lastname_of_member" type="text"
                value="<?php echo $member['_tmm_lastname']; ?>"
        ...
        <div class="dmb_grid dmb_grid_25">
            ...
            <input class="dmb_field dmb_job_of_member" type="text"
                value="<?php echo $member['_tmm_job']; ?>"
        ...
        <div class="dmb_grid dmb_grid_25 dmb_grid_last">
            ...
            <div style="position:relative; top:8px;">
                <input class="dmb_field dmb_hide_of_member" type="checkbox" value="1" <?php if ('1' == $member['_tmm_hide']) {
                    echo 'checked';
                } ?> /> Check to
                hide member
            </div>
        ...
        <div class="dmb_grid dmb_grid_100 dmb_grid_first dmb_grid_last">
            ...
            <textarea
                id="acf-fallback-bio"><?php echo $member['_tmm_desc']; ?></textarea>
        ...
        <div class="dmb_grid dmb_grid_33 dmb_grid_last">
            ...
            <input class="dmb_field dmb_scl_url1_of_member" type="text"
                value="<?php echo $member['_tmm_sc_url1']; ?>"
        ...
        <div class="dmb_grid dmb_grid_33 dmb_grid_last">
            <input class="dmb_field dmb_scl_url2_of_member" type="text"
                value="<?php echo $member['_tmm_sc_url2']; ?>"
                placeholder="<?php _e('e.g. http://fb.com/member-profile', TMMP_TXTDM); ?>" />
        </div>
        ...
        <div class="dmb_grid dmb_grid_33 dmb_grid_last">
            <input class="dmb_field dmb_scl_url3_of_member" type="text"
                value="<?php echo $member['_tmm_sc_url3']; ?>"
        ...
        <div class="dmb_grid dmb_grid_33 dmb_grid_last">
            <input class="dmb_field dmb_scl_url4_of_member" type="text"
                value="<?php echo $member['_tmm_sc_url4']; ?>"
                placeholder="<?php _e('e.g. http://gp.com/member-profile', TMMP_TXTDM); ?>" />
        </div>
        ...
        <div class="dmb_grid dmb_grid_33 dmb_grid_last">
            <input class="dmb_field dmb_scl_url5_of_member" type="text"
                value="<?php echo $member['_tmm_sc_url5']; ?>"
                placeholder="<?php _e('e.g. http://gp.com/member-profile', TMMP_TXTDM); ?>" />
        </div>
        ...
        <div class="dmb_grid dmb_grid_33 dmb_grid_first">
            ...
            <div>
                <div class="dmb_field_title dmb_img_data_url dmb_photo_of_member"
                    data-img="<?php echo $member['_tmm_photo']; ?>">
                </div>
        ...
        <div class="dmb_grid dmb_grid_33 dmb_grid_last">
            ...
            <div>
                <div class="dmb_field_title dmb_img_data_url dmb_hover_photo_of_member"
                    data-img="<?php echo $member['_tmm_photo2']; ?>">
                </div>
                <div class="dmb_upload_img_btn dmb_button dmb_button_large dmb_button_blue">
                    <?php _e('Upload photo', TMMP_TXTDM); ?>
                </div>
